 ...
 * limpa todas as colecoes do Firestore Emulator entre casos de teste,
 * evitando vazamento de estado (ex.: produtos/pedidos criados em um teste
 * vazando para o proximo). Orders e o unico codebase da Fase 3 com escrita
 * na colecao `pedidos` (ver Decisao tecnica 3 do BACKLOG).
 */
