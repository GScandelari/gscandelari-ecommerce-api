...
/**
 * Testes de integracao de Pedidos - RN02 a RN09, RN07a (Modulo 3 - Epico 3.3).
 *
 * ESTADO ESPERADO ATUAL (TDD "vermelho"): as rotas /produtos e /pedidos
 * (Modulo 2 - Epicos 2.5/2.6) AINDA NAO EXISTEM em src/app.ts. Toda
 * requisicao abaixo recebera 404 do Express, entao praticamente todas as
 * asserções falharão até a implementação existir - esse é o comportamento
