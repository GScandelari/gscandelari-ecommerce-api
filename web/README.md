# web/ — Front-end de testes

SPA em **React + Vite + TypeScript**, ferramenta de teste/demonstração do serviço Orders (`services/orders/`, único que expõe `/produtos` e `/pedidos`). Roda **exclusivamente contra o Firebase Emulator Suite local** — nunca contra um projeto Firebase real (RN27, ver `SPEC.md` seção "Fase 4").
...
- [`../README.md` — seção "Front-end de testes — `web/`"](../README.md#front-end-de-testes--web)
